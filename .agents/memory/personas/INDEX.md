...
Store: user-confirmed clauses with evidence and scope; role-specific personas
...
| slug | one-liner | scope | status | updated | file |
|------|-----------|------|--------|---------|------|
| founder-operator | Compact, direct, evidence-first collaboration protocol | all sessions | active | 2026-09-15 | `founder-operator.md` |
